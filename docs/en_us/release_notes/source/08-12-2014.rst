...
* This release includes a redesigned user experience for publishing. 
  ...
  *  Visual cues are now present on the **Course Outline**  page and on
  ...
  For a comparison between the new publishing workflow and the previous workflow, see our most recent `edX Product and Engineering Newsletter`_.
...
We're pleased to announce these upcoming changes to course discussions, which
will release in the next few weeks:
